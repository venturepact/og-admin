...
export class CompanyDetailComponent implements OnInit {
	...
	planList : any;
	constructor(
		public companyService: CompanyService, public fb: FormBuilder,
		public route: ActivatedRoute,  public _adminService: AdminService, public _membershipService: MembershipService) {
	...
	ngOnInit() {
		...
		//console.log("company",this.updateCompany);
	...
	getPlanList() {
		...
		.subscribe((result) => {
			...
			// console.log(this.planList,' planLIst');
		},(error) => {
		...
		if (this.updateFormdetail.valid) {
          ...
          jQuery('#btnSaveDetail').text('Update').attr('disabled',false);
				...
				(error: any) => {
					...
					//console.log('getCompanyInfo Err', error);
