...
export class AccountDetailsComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.updateFormdetail = this.fb.group({
        ...
        phone: [this.updateModel.name, Validators.compose([])],
        ...
        two_fact_auth:[this.updateModel.two_fact_auth.is_configured, Validators.compose([Validators.required])],
        can_use_default_password:[this.updateModel.can_use_default_password, Validators.compose([Validators.required])]
    })
  ...
  updateUser() {
    ...
    if (this.updateFormdetail.valid) {
      this.loading = true;
      this._userService.updateBasicDetails(this.updateModel, true).subscribe((result) => {
        this.model = new User(result);
